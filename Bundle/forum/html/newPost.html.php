...
<html>
	<ul class="breadcrumb">
		...
		<li><a href="/@/forum/categorie/<?php echo $_GET['cat']; ?>" >Cat&eacute;gorie <?php //echo $post->getCategorie(); ?></a> <span class="divider">/</span></li>
...
<form class="bs-docs-question" action="" method="post">
			...
			<input style="margin-top:4px;" type="submit" class="btn" value="Poster ma question">
</form>